...
primesieve: src/primesievemain.c build/primesieve.o build/bitops.o
	$(CC) -o primesieve src/primesievemain.c build/primesieve.o build/bitops.o -O1
...
semiprimesieve: src/semiprimesievemain.c build/semiprimesieve.o build/primesieve.o build/bitops.o
	$(CC) -o semiprimesieve src/semiprimesievemain.c build/semiprimesieve.o build/primesieve.o build/bitops.o -O2
